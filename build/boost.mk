...
override BOOST_COMPILE_TRUE = $(call mc_define_append,CONFIG_BOOST_COMPILE,yes,$@); $(call mc_info_append,C++ compiler can find Boost headers,$@)
override BOOST_LINK_TRUE = $(call mc_define_append,CONFIG_BOOST_LINK,yes,$@); $(call mc_info_append,C++ linker can link to Boost libraries,$@)
