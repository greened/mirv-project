...
$(call mc_try_executable_c,C_COMPILE_SOURCE,C_COMPILE_COMPILE_TRUE,C_COMPILE_ERROR,C_COMPILE_LINK_TRUE,C_COMPILE_ERROR,$(C_COMPILE_COMPILE_MK),$(C_COMPILE_LINK_MK))
...
$(call mc_try_execute,CC_EXECUTE,C_EXECUTE_RUN,C_EXECUTE_TRUE,C_EXECUTE_FALSE,$(FINAL_BUILDDIR)/configure/GCC_TRY.mk)
