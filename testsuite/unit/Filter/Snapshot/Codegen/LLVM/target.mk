...
libmirvfilter_codegen_llvm_test_LIBS = $(filter %.a,$(libmirvfilter_codegen_llvm_LIBRARIES) $(libmirvfilter_codegen_llvm_LIBRARIES) $(libmirv_core_LIBRARIES))
libmirvfilter_codegen_llvm_test_INCLUDES = $(FINAL_BUILDDIR)/include

# FIXME: Do not hardcode path to LLVM libraries.
libmirvfilter_codegen_llvm_LIBS = $(shell llvm-config-2.7 --libs core)

$(call make_unittest,libmirvfilter_codegen_llvm_test,$(libmirvfilter_codegen_llvm_test_SRCDIR),$(libmirvfilter_codegen_llvm_test_LIBS),$(libmirvfilter_codegen_llvm_test_INCLUDES),,,,-static -L/usr/lib/llvm/lib $(libmirvfilter_codegen_llvm_LIBS) -lpthread -ldl -lm,$(libmirvfilter_codegen_llvm_test_LIBS) $(libmirvfilter_codegen_llvm_test_INCLUDES))
